...
joystickStories.add("Default joystick with small stick", function () { return React.createElement(Joystick_1.Joystick, { stickSize: 10, start: (0, addon_actions_1.action)("Started"), move: (0, addon_actions_1.action)("Moved"), stop: (0, addon_actions_1.action)("Stopped") }); });
...
joystickStories.add("Y Axis only", function () { return React.createElement(Joystick_1.Joystick, { controlPlaneShape: shape_enum_1.JoystickShape.AxisY, start: (0, addon_actions_1.action)("Started"), throttle: 50, move: (0, addon_actions_1.action)("Moved"), stop: (0, addon_actions_1.action)("Stopped") }); });
joystickStories.add("X Axis only", function () { return React.createElement(Joystick_1.Joystick, { controlPlaneShape: shape_enum_1.JoystickShape.AxisX, start: (0, addon_actions_1.action)("Started"), throttle: 50, move: (0, addon_actions_1.action)("Moved"), stop: (0, addon_actions_1.action)("Stopped") }); });
